...
{
    public static function reportePDF(Router $router)
    {
        ...
        try {
            ...
            $header = $router->load('pdf/header', $datos);
            $html = $router->load('pdf/reporte', $datos);
            $footer = $router->load('pdf/footer', $datos);
