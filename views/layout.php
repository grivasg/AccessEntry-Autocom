                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                    ...
                    <div class="nav-item dropdown ">
                        ...
                        <ul class="dropdown-menu  dropdown-menu-dark " id="dropwdownRevision" style="margin: 0;">
                            ...
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/aplicaciones/nueva">Solicitudes <i class="bi bi-bell-fill"></i></a>
                            </li>
                    ...
                    <div class="nav-item dropdown ">
                        ...
                        <ul class="dropdown-menu  dropdown-menu-dark " id="dropwdownRevision" style="margin: 0;">
                            <!-- <h6 class="dropdown-header">Información</h6> -->
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/aplicaciones/nueva"><i class="bi bi-hourglass-split"></i> Verificar Estado </a>
                            </li>
